...
.NOTES
    Doit être exécuté avec des privilèges égaux ou supérieurs à ceux de l'application cible. Si le script est lancé
    en tant qu'utilisateur standard, il ne pourra pas interagir avec une fenêtre lancée en tant qu'administrateur.
#>
